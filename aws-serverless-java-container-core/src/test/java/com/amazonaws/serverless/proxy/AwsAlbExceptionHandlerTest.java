...
public class AwsAlbExceptionHandlerTest {
    ...
    void typedHandle_InvalidRequestEventException_500State() {
        ApplicationLoadBalancerResponseEvent resp = exceptionHandler.handle(new InvalidRequestEventException(INVALID_REQUEST_MESSAGE, null));
    ...
    void typedHandle_InvalidResponseObjectException_502State() {
        ApplicationLoadBalancerResponseEvent resp = exceptionHandler.handle(new InvalidResponseObjectException(INVALID_RESPONSE_MESSAGE, null));
    ...
    void typedHandle_InternalServerErrorException_500State() {
        ...
        ApplicationLoadBalancerResponseEvent resp = exceptionHandler.handle(mockInternalServerErrorException);
    ...
    void typedHandle_NullPointerException_responseObject()
            throws JsonProcessingException {
        ApplicationLoadBalancerResponseEvent resp = exceptionHandler.handle(new NullPointerException());
    ...
    void streamHandle_InvalidRequestEventException_500State()
        ...
        ApplicationLoadBalancerResponseEvent resp = objectMapper.readValue(new ByteArrayInputStream(respStream.toByteArray()), ApplicationLoadBalancerResponseEvent.class);
        assertNotNull(resp);
        assertEquals(500, resp.getStatusCode());
    }
