...
public class JerseyInjectionTest {
    ...
    private static JerseyLambdaContainerHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> handler = JerseyLambdaContainerHandler.getAwsProxyHandler(
            app);
